...
if !errorlevel!==0 (
    for /f "tokens=2*" %%A in ('reg query "HKLM\System\CurrentControlSet\Services\robloxzapret" /v robloxzapret-discord-youtube 2^>nul') do echo Service strategy installed from "%%B"
)
...
reg add "HKLM\System\CurrentControlSet\Services\robloxzapret" /v robloxzapret-discord-youtube /t REG_SZ /d "!filename!" /f
...
if !errorlevel!==0 (
    ...
    call :PrintRed "https://github.com/Flowseal/robloxzapret-discord-youtube/issues/417"
) else (
...
if !errorlevel!==0 (
    ...
    call :PrintRed "https://github.com/Flowseal/robloxzapret-discord-youtube/issues/2512#issuecomment-2821119513"
) else (
...
if !errorlevel!==0 (
    call :PrintYellow "[?] Some VPN services found. Some VPNs can conflict with robloxzapret"
